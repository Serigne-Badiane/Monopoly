...
int menu1 (int* nombreDeJoueur, int* nombreDeDeplacement, int* tourJoueur, t_joueur player[NbJoueurMax][TAILLE], int* chargement){
    ...
    gotoligcol(19,11);
    printf("%c%c%c%c%c%c%c%c%c%c%c\n",201,202,205,205,205,205,205,205,187,204,187);
    gotoligcol(20,11);
    printf("%c   %c   %c%c%c\n",186,36,204,188,186);
    gotoligcol(21,11);
    printf("%c%c%c%c%c%c%c%c%c%c%c\n",200,205,205,205,205,205,205,205,202,205,188);
    ...
    Color(11,0);
    gotoligcol(22,58);
    printf("5.-Cr%cdit",0x82);
    gotoligcol(25,49);
    scanf("%d",&menu);

    while (menu!=1&&menu!=2&&menu!=3&&menu!=4&&menu!=5) //blindage choix au menu
    {
        Color(3,0);
    ...
    if(menu==1)
    {
        system("cls");
        Color(3,0);
        printf("\n\n\nIA : Bonjour humains, ca fait longtemps que je vous attendais, vous en avez mis du temps a me trouver ! Je dois vous communiquer une information grave, l'Univers est en danger et vous etes les seuls etres vivants pouvant selon moi remettre les choses dans l'ordre ici, il y a %cnormement de choses encore que vous ne savez pas a propos du cosmos, suivez moi nous partons avec ma fu%ce\n\n", 0x82,0x82);
        Color(15,0);
    ...
    {
        int sauvegarde=1;
        printf("\nSauvegarde, appuyez sur 1 pour lancer les des ");
        return sauvegarde;
    }
