...
void mercure()
{
    ...
    char anecdotes [] = "Mercure est la plan�te la plus proche du syst�me solaire, il y fait une temperature moyenne de 167 degres pouvant montant jusqu'a 427 degres ! Elle est 3 fois plus petite que notre Terre mais egalement 20 moins massive.";
